...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_LGUI, KC_LALT, KC_WSCH, ADJUST,  KC_SPC, LOWER,   RAISE,   KC_SPC,  KC_MINS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
    ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_CAPS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_MNEXT, KC_MPLY, KC_F12,  _______, KC_PGDN, KC_PGUP, KC_UP, _______, \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______, KC_MNEXT, KC_MPLY, _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
